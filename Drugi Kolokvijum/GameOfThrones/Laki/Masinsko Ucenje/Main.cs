...
namespace Masinsko_Ucenje
{
    public partial class Main : Form
    {
        ...
        enum Header
        {
            ...
            book3, book4, book5, isAliveMother, isAliveFather, isAliveHeir, isAliveSpouse, isMarried, isNoble, age, numDeathRelations, boolDeathRelations, isPopular, Popularity, isAlive
        }
        ...
        private void btnLinearRegression_Click(object sender, EventArgs e)
        {
            ...
            foreach (string line in lines)
            {
               ...
               // Console.WriteLine("Prvi: " + parts[(int)Header.numDeathRelations] + "aa: " + parts[(int)Header.Popularity]);
               // break;
                x.Add(double.Parse(parts[(int)Header.numDeathRelations]));
                y.Add(double.Parse(parts[(int)Header.Popularity]));
            }
            ...
            Console.WriteLine("5 ubijenih: " +  regression.predict(5));
            Console.WriteLine("10 ubijenih: " +  regression.predict(10));
            Console.WriteLine("15 ubijenih: "+  regression.predict(15));
        }
