...
namespace Masinsko_Ucenje
{
    public partial class Main : Form
    {
        ...
        private void btnKmeans_Click(object sender, EventArgs e)
        {
            ...
            {
                string[] parts = line.Split(',');
                double col1 = double.Parse(parts[(int)Header.Col_1]);
                double col2 = double.Parse(parts[(int)Header.Col_2]);
                double col3 = double.Parse(parts[(int)Header.Col_3]);
                double col4 = double.Parse(parts[(int)Header.Col_4]);
                kmeansElements.Add(new Point(col1, col2, col3, col4));
            }
